...
// parse the server_file to get ids of all available servers
void findAllServers(std::string server_file) {
    int server_idx;
...
int main(int argc, char * argv[]) {
    ...
    cmd.AddValue("input", "Name of the input file.",
        input);
    cmd.AddValue("servers", "Name of the input file showing available servers",
        server_file);
    ...
    */
    ...
    findAllServers(server_file);
    std::cout << "Total number of links: " << totlinks << std::endl;
    std::cout << "Total number of available servers: " << server_idx_list.size() << std::endl;
